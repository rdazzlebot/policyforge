...
# or, without Homebrew:
# pipx install git+https://github.com/rdazzlebot/policyforge@v1.3.0
...
`mcp`) are not included. Without Homebrew, `pipx install git+https://github.com/rdazzlebot/policyforge@v1.3.0` does the same, and
